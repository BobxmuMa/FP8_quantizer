...
class QuantizationPolicy:
    ...
    def __repr__(self) -> str:
        return 'QuantizationPolicy({})'.format({
            property.name
            for property in QuantizationProperty if self.has_property(property)==True
        })
...
class TensorQuantizationConfig(Serializable):
    ...
    def __repr__(self) -> str:
        return 'TensorQuantizationConfig(policy:{}, num_of_bits:{}, exponent_bits:{}, scale:{}, offset:{}, state:{}, quant_max:{})'\
            .format(self._policy, self._num_of_bits, self._exponent_bits, self._scale, self._offset, self.state, self._quant_max)
