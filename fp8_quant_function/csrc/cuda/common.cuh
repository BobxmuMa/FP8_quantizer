...
float QuantizeScalarFloating(
    ...
    // printf("%f, %u, %d, %d", helper.value, helper.data, exponent_min, exponent_max);
    ...
    // printf("%u, %d, %d, %u, %f", fp32_sign, fp32_exp, fp32_mantissa, helper.data, theoretical_maximum);
    
    // printf("%u, %d, %d, %u\n", fp32_sign, fp32_exp, fp32_mantissa, helper.data);
    // printf("%f, ", theoretical_maximum);
    // printf("\n");
